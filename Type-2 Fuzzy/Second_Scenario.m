...
for iteration=1:10
    vacc = mamfistype2("NumInputs", 2, "NumOutputs", 2, 'NumInputMFs', 2 , 'NumOutputMFs', 3, 'MFType', "gaussmf"); %,'NumInputMFs',5,'NumOutputMFs',5
    ...
    save('result/second_scenario_optimization_'+string(iteration)+'q5_ka5.mat')
    %% test
    I_un_std = [];
    x_std = [];
    I_std = [];
